...
func (_m *MockBot) Send(c tgbotapi.Chattable) (tgbotapi.Message, error) {
	ret := _m.Called(c)
...
// MockBot_Send_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Send'
type MockBot_Send_Call struct {
	*mock.Call
}

// Send is a helper method to define mock.On call
//   - c tgbotapi.Chattable
func (_e *MockBot_Expecter) Send(c interface{}) *MockBot_Send_Call {
	return &MockBot_Send_Call{Call: _e.mock.On("Send", c)}
}

func (_c *MockBot_Send_Call) Run(run func(c tgbotapi.Chattable)) *MockBot_Send_Call {
...
func (_c *MockBot_Send_Call) Return(_a0 tgbotapi.Message, _a1 error) *MockBot_Send_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockBot_Send_Call) RunAndReturn(run func(tgbotapi.Chattable) (tgbotapi.Message, error)) *MockBot_Send_Call {
	_c.Call.Return(run)
	return _c
}
